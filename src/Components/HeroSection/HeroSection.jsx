...
const HeroSection = () => {
  ...
  const getData = async ()=>{
    const data = await axios.get('https://fakestoreapi.com/products').then((response)=> response.data)
  ...
  <div className="section-left">
      ...
      <SwiperSlide><div className='slide3'>
          <div className="section-left">
      ...
      <SwiperSlide><div className='slide4'>
          <div className="section-left">
